...
function startBanner() { 
    ...
    tl.add("sequence 1");
        tl.to("#peacock_animation", 5, {ease: Power2.easeInOut, scale:0.12}, "+=1.5");
    ...
    tl.add("sequence 2");
        ...
        tl.set(["#peacock_animation"], {scale:0.7, y:-60, autoAlpha:0});
        tl.to("#peacock_animation", 1, {ease: Power2.easeInOut, autoAlpha:1}, "+=0");
        tl.from("#white_box", 0.5, {ease: Sine.easeOut, y:130}, "-=0.5");
